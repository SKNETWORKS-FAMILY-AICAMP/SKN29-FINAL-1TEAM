...
| **규정 문서 관리 (S-05)**<br>조 단위로 조항을 정리하고, 확인 필요 조항마다 룰 생성 여부를 결정<br><img src="docs/assets/s05-policy-docs.png" width="420" /> | **예산 관리 (S-08)**<br>계정과목별 예산 소진율·산정 지표·지출 추세<br><img src="docs/assets/s08-budget.png" width="420" /> |
| **카드 관리 (S-09)**<br>팀·개인별 법인카드 배정 현황과 회수/중지 큐<br><img src="docs/assets/s09-card-management.png" width="420" /> | **AI-LAB (관리자 실험)**<br>운영과 같은 코드로 Agent·RAG를 단독 실행, 근거를 그대로 노출<br><img src="docs/assets/ai-lab.png" width="420" /> |
...
| | |
|---|---|
| 시연 영상 | [`scrum/산출물/06.발표/시연영상/최종발표_시연영상.mp4`](scrum/산출물/06.발표/시연영상/최종발표_시연영상.mp4) |
| 발표 자료 (PDF) | [`scrum/산출물/06.발표/최종발표/최종발표_호냥이_최종버전.pdf`](scrum/산출물/06.발표/최종발표/최종발표_호냥이_최종버전.pdf) |
...
전체 미완/미연동 항목, 알려진 함정은 **[`docs/SETUP.md`](docs/SETUP.md)** 에 정리돼 있다.
...
├── scrum/                       # 주차별 스크럼·발표 산출물
├── docs/                        # 사람이 읽는 운영·셋업 문서(SETUP.md) + README 이미지 자산
└── apps/
...
- **[`docs/SETUP.md`](docs/SETUP.md)** — 시드 데이터 전략, RAG 적재, 자주 쓰는 명령, 알려진 함정