        ...
        <div className="grid-2">
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="field"><label>가맹점명 <span className="tag ai">AI</span></label><input defaultValue="강남한식당" /></div>
              <div className="field"><label>거래일시 <span className="tag ai">AI</span></label><input defaultValue="2026-07-18 19:20" /></div>
              <div className="field"><label>금액 <span className="tag ai">AI</span></label><input defaultValue="452,000원" /></div>
            ...
            <div className="modal-foot">
              ...
              <div className="spacer" />
              <button className="btn primary" onClick={() => setStep(3)}>저장하고 제출하기</button>
            </div>
          </div>
        </div>
      )}
      ...
      {step === 3 && (
        <div className="card" style={{ maxWidth: 420 }}>
          <div className="card-body stack" style={{ alignItems: 'center', textAlign: 'center', padding: 'var(--space-6) var(--space-4)' }}>
            ...
            <p className="text-meta">지출 등록이 완료됐습니다. 정산 상태는 내 지출 목록에서 확인할 수 있어요.</p>
