...
|---|---|---|---|---|
| `요구사항_명세서.md` | Draft v0.5 | 기능/비기능 요구사항(FR-*), 상태머신, Open Issue | 최신 · S-02 행 정렬·상세 facts/증빙/이력 반영 | 2026-07-28 |
| `기술명세서.md` | Draft v0.2 | 아키텍처·데이터·API·FastMCP Tool·ML/RAG·룰 그래프 | 최신 · §3.1a Capability RBAC · §4.2 S-04 그래프단위 콘솔 반영 | 2026-07-30 |
