...
| Risk Review Agent | ✅ v1 | 1차 이상탐지(`anomaly.pkl`+`risk_tier`) → 2차 RAG 내규검증(MCP 툴콜링, 분류/액션 2단). → [[risk-review-agent-v1-implementation]] |
...
| S-08 예산 / S-09 카드 | ✅ 실 연동 | 저장하는 건 사람의 결정뿐 — 사용액·「회수 필요」는 파생 |
